...
namespace Drupal\Tests\books_hardcover\Unit\Services;
 ...
 * @coversDefaultClass \Drupal\books_hardcover\Services\HardcoverService
 */
class HardcoverServiceTest extends UnitTestCase {
   ...
   *
   * @return \Drupal\books_hardcover\Services\HardcoverService
