...
namespace Drupal\Tests\books_book_managment\Unit\Commands;

use Drupal\books_book_managment\Commands\BooksBookManagmentCommands;
 ...
 * @coversDefaultClass \Drupal\books_book_managment\Commands\BooksBookManagmentCommands
 */
class BooksBookManagmentCommandsTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\books_book_managment\Commands\BooksBookManagmentCommands
   */
  protected $command;
  ...
  protected function setUp(): void {
    ...
    $this->command = new BooksBookManagmentCommands(
      $this->createMock(BooksUtilsService::class),
      $queueFactory,
      $workerManager
    );
